...
discovered,
- they will be integrated into the proposed compendium. Data
...
variables, [^ purpose of the program, and requirements needed by the user].Code will be annotated to promote code readability
...
Depending on such policies, materials may be transferred to others under the terms
...
versioned 
      a. over time and maintained in a date-stamped file structure with
text files 
      a. documenting the provenance. The database will be preserved in
      a. perpetuity, 
1. housed initially at the New Mexico Interstate Stream
...
repository. A data policy and stewardship plan will be established. 
1. In addition to archiving, each database table will be exported to a
